...
namespace PowerBiRestAPI {
  ...
  public class DataFactory {
    ...
    //private static Random RandomNumberFactory = new Random(Guid.NewGuid().GetHashCode());
    ...
    public static ContributionData GetNextContribution() {
      ...
      switch (ContributionGrowthPhase) {
        ...
        case 2:
          ...
          break;
        case 3:
          if (RandomNumberFactory.Next(1, 100) > 80) { Gender = "M"; }
          break;
        case 4:
          if (RandomNumberFactory.Next(1, 100) > 72) { Gender = "M"; }
          break;
        case 5:
          if (RandomNumberFactory.Next(1, 100) > 62) { Gender = "M"; }
          break;
        case 6:
          if (RandomNumberFactory.Next(1, 100) > 45) { Gender = "M"; }
          break;
        case 7:
          if (RandomNumberFactory.Next(1, 100) > 48) { Gender = "M"; }
          break;
        case 8:
          if (RandomNumberFactory.Next(1, 100) > 40) { Gender = "M"; }
          break;
        case 9:
          if (RandomNumberFactory.Next(1, 100) > 50) { Gender = "M"; }
          break;
        case 10:
          if (RandomNumberFactory.Next(1, 100) > 58) { Gender = "M"; }
          break;
      }
