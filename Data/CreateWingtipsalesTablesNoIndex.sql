...
IF OBJECT_ID(N'[dbo].[FK_CustomerInvoice]', 'F') IS NOT NULL ALTER TABLE [Invoices] DROP CONSTRAINT [FK_CustomerInvoice];
IF OBJECT_ID(N'[dbo].[FK_InvoiceInvoiceDetail]', 'F') IS NOT NULL ALTER TABLE [InvoiceDetails] DROP CONSTRAINT [FK_InvoiceInvoiceDetail];
IF OBJECT_ID(N'[dbo].[FK_ProductInvoiceDetail]', 'F') IS NOT NULL ALTER TABLE [InvoiceDetails] DROP CONSTRAINT [FK_ProductInvoiceDetail];
